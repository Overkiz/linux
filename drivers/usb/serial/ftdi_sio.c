...
static const struct usb_device_id id_table_combined[] = {
	...
	/* OVERKIZ SAS devices */
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBCF_ZWE_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBCF_ENO_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBRD_ZWE_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBRD_ENO_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBRD_RTS_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBRD_IO_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBRD_ZBEE_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_MBRD_GSM_PID) },
	{ USB_DEVICE(OVERKIZ_VID, OVERKIZ_VID_DONGLE_ZBEE_PID) },
	{ }					/* Terminating entry */
};
