...
static void cycle_start(struct cycle_trig_data *data)
{
	unsigned long flags;
...
static void cycle_stop(struct cycle_trig_data *data)
{
	unsigned long flags;
...
static void cycle_reset(struct cycle_trig_data *data)
{
	data->plot_index = 0;
	data->cycle_count = 0;
}

static void cycle_pause(struct cycle_trig_data *data)
{
	unsigned long flags;
...
static void cycle_resume(struct cycle_trig_data *data)
{
	unsigned long flags;
...
static ssize_t cycle_control_show(struct device *dev,
				  struct device_attribute *attr, char *buf)
{
...
static DEVICE_ATTR(control, 0644, cycle_control_show, cycle_control_store);
